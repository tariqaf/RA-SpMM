...
Why: GNN practitioners overwhelmingly call SpMM through PyG, so torch_sparse's
SparseTensor.matmul() is the natural framework baseline; internally it dispatches to cuSPARSE for most cases but the
