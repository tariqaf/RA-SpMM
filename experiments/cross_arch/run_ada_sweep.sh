...
# sweep (deployed kernel/precision paths + cuSPARSE + router), evaluates router
# quality, and computes
...
echo "   [x] Same deployed kernel roster + router as the 3090 headline results"
echo "=================================================================="
...
echo "[3/5] Full sweep: deployed roster + cuSPARSE, 26 graphs x N in {64,128,256,512} ..."
